...
Page({
  ...
  onSave: function () {
    ...
    var submitData = {
      ...
      stockEnabled: formData.stock ? parseFloat(formData.stock) > 0 : false,
      stock: formData.stock ? (parseFloat(formData.stock) || 0) : 0,
      stockUnit: formData.stock ? formData.stockUnit : '片',
      stockWarning: formData.stock ? (parseInt(formData.stockWarning) || 10) : 0,
