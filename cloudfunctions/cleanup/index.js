...
/**
 * 4. 去重：查询 reminders 中 status 为 pending 且在同 medicationId+timeStr 下
...
exports.main = async (event, context) => {
  ...
  try {
    if (action === 'run') {
      var result = { migrated: 0, ghostReminders: 0, orphanRecords: 0, deduped: 0 };
